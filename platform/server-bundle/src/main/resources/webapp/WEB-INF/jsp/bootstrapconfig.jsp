            ...
            <div class="diver">
                <form action="bootstrap.do" method="POST" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="radio" value="file" name="configSource"><span class="label-radio">{{msg('server.configSource.file')}}</span>
                            <input type="radio" value="ui" name="configSource"/><span class="label-radio">{{msg('server.configSource.ui')}}</span>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
