...
public interface ConfigurationService {
     ...
     *             property <code>bootstrap.config.default.file.path</code> in the file <code>config.properties</code>.
     *             <code>config.properties</code> should be present in the root of classpath. A <code>config.properties</code>
     *             is provided in the bundle jar with <code>bootstrap.config.default.file.path</code> set to
