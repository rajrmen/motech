...
public class ConfigLocation {
     ...
     * Similarly, if the requested access type check is {@link ConfigLocation.FileAccessType.WRITEABLE}, then the
     ...
     * @param accessType One of {@link ConfigLocation.FileAccessType.READABLE} or {@link ConfigLocation.FileAccessType.WRITEABLE}.
     * @return File relative to the config location.
     * @throws MotechConfigurationException if the file is not readable or writeable depending on the given access type.
     */
