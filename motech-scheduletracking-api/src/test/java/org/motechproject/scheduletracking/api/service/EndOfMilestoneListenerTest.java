...
public class EndOfMilestoneListenerTest {
    ...
    public void shouldDefaultEnrollmentAtTheCurrentMilestoneIfNotFulfilled() {
        Enrollment enrollment = new Enrollment("entity_1", "my_schedule", "first_milestone", weeksAgo(4).toDateTimeAtCurrentTime(), weeksAgo(4).toDateTimeAtCurrentTime(), new Time(8, 10));
