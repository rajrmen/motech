...
public class EnrollmentTest {
    ...
    public void shouldStartWithFirstMilestoneByDefault() {
        ...
        Enrollment enrollment = new Enrollment("ID-074285", "Yellow Fever Vaccination", "First Shot", weeksAgo(5).toDateTimeAtCurrentTime(), weeksAgo(5).toDateTimeAtCurrentTime(), null);
    ...
    public void shouldStartWithSecondMilestone() {
        ...
        Milestone firstMilestone = new Milestone("First Shot", wallTimeOf(1), wallTimeOf(2), wallTimeOf(3), wallTimeOf(4));
        schedule.addMilestones(firstMilestone, secondMilestone);
        Enrollment lateEnrollment = new Enrollment("my_entity_1", "Yellow Fever Vaccination", "Second Shot", weeksAgo(3).toDateTimeAtCurrentTime(), weeksAgo(3).toDateTimeAtCurrentTime(), null);
    ...
    public void shouldReNullWhenNoMilestoneIsFulfilledlled() {
        ...
        Milestone firstMilestone = new Milestone("First Shot", wallTimeOf(1), wallTimeOf(2), wallTimeOf(3), wallTimeOf(4));
        schedule.addMilestones(firstMilestone, secondMilestone);
        Enrollment enrollment = new Enrollment("ID-074285", "Yellow Fever Vaccination", "First Shot", weeksAgo(5).toDateTimeAtCurrentTime(), weeksAgo(3).toDateTimeAtCurrentTime(), null);
    ...
    public void shouldReturnTheDateWhenAMilestoneWasLastFulfilled() {
        ...
        schedule.addMilestones(firstMilestone, secondMilestone);
        Enrollment enrollment = new Enrollment("ID-074285", "Yellow Fever Vaccination", "First Shot", weeksAgo(5).toDateTimeAtCurrentTime(), weeksAgo(3).toDateTimeAtCurrentTime(), null);
        enrollment.getFulfillments().add(new MilestoneFulfillment("First Shot", weeksAgo(0).toDateTimeAtCurrentTime()));

        assertEquals(weeksAgo(0).toDateTimeAtCurrentTime(), enrollment.getLastFulfilledDate());
    }
