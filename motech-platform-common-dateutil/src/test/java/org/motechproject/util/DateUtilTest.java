...
public class DateUtilTest {
    ...
    public void shouldFindDaysToCalendarWeekEnd() {
        ...
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 19), DayOfWeek.Wednesday.getValue()), is(3));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 20), DayOfWeek.Wednesday.getValue()), is(2));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 21), DayOfWeek.Wednesday.getValue()), is(1));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 22), DayOfWeek.Wednesday.getValue()), is(0));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 23), DayOfWeek.Wednesday.getValue()), is(6));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 24), DayOfWeek.Wednesday.getValue()), is(5));

        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 19), DayOfWeek.Monday.getValue()), is(1));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 20), DayOfWeek.Monday.getValue()), is(0));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 21), DayOfWeek.Monday.getValue()), is(6));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 22), DayOfWeek.Monday.getValue()), is(5));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 23), DayOfWeek.Monday.getValue()), is(4));
        assertThat(daysToCalendarWeekEnd(newDate(2011, 11, 24), DayOfWeek.Monday.getValue()), is(3));
    }
    ...
    public void shouldReturnEndOfDayForGivenTime() {
        ...
        assertEquals(new DateTime(2010, 10, 10, 23, 59, 59, 999), endOfDay(time.toDate()));
    }
    ...
    public void shouldReturnWhetherGivenDateTimeFallsUnderSpecifiedInclusiveRange() {
        ...
        assertTrue(inRange(reference, new DateTime(2010, 10, 9, 12, 22, 22, 223), new DateTime(2010, 10, 11, 12, 22, 22, 223)));
        assertTrue(inRange(reference, new DateTime(2010, 10, 10, 12, 22, 22, 223), new DateTime(2010, 10, 11, 12, 22, 22, 223)));
        assertTrue(inRange(reference, new DateTime(2010, 10, 9, 12, 22, 22, 223), new DateTime(2010, 10, 10, 12, 22, 22, 223)));
        assertFalse(inRange(reference, new DateTime(2010, 10, 9, 12, 22, 22, 223), new DateTime(2010, 10, 10, 12, 22, 22, 222)));
        assertFalse(inRange(reference, new DateTime(2010, 10, 10, 12, 22, 22, 224), new DateTime(2010, 10, 10, 12, 22, 22, 223)));
        assertTrue(inRange(reference, new DateTime(2010, 10, 9, 12, 22, 22, 224), new DateTime(2010, 10, 10, 12, 22, 22, 223)));

    }

    @Test
    public void shouldReturnTimeFromDateTime() {
        assertThat(time(new DateTime(2012, 12, 2, 19, 9, 38)), Is.is(new Time(19, 9)));
        assertThat(time(new DateTime(2012, 12, 2, 1, 58, 57)), Is.is(new Time(1, 58)));
    }
