...
public class VerboiceIVRControllerDecisionTreeIT extends SpringIntegrationTest {
    ...
    public void shouldTestVerboiceXMLResponse() throws Exception {
        ...
        Assert.assertTrue(response.contains("<Gather method=\"POST\" action=\"http://localhost:8080/verboice/ivr?type=verboice&amp;ln=en&amp;tree=someTree&amp;trP=Lw\" numDigits=\"1\"></Gather>"));
    ...
    public void shouldReturnVerboiceML() throws Exception {
        HttpClient client = new DefaultHttpClient();
        final String vmlUrl = "http://localhost:8080/verboice/ivr?tree=someTree&type=verboice&pId=asd&ln=en&tNm=someTree&trP=Lw==";
