...
public class MRSPerson {
    ...
    public boolean equals(Object o) {
        ...
        if (!ObjectUtils.equals(id, other.id)) return false;
        if (!ObjectUtils.equals(firstName, other.firstName)) return false; 
        if (!ObjectUtils.equals(middleName, other.middleName)) return false; 
        if (!ObjectUtils.equals(lastName, other.lastName)) return false; 
        if (!ObjectUtils.equals(preferredName, other.preferredName)) return false; 
        if (!ObjectUtils.equals(address, other.address)) return false; 
        if (!ObjectUtils.equals(dateOfBirth, other.dateOfBirth)) return false; 
        if (!ObjectUtils.equals(birthDateEstimated, other.birthDateEstimated)) return false; 
        if (!ObjectUtils.equals(age, other.age)) return false; 
        if (!ObjectUtils.equals(gender, other.gender)) return false; 
        if (!ObjectUtils.equals(attributes, other.attributes)) return false; 
        if (!ObjectUtils.equals(deathDate, other.deathDate)) return false; 
