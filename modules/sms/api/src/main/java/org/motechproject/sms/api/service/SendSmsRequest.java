...
public class SendSmsRequest {
    ...
    /**
     * Request to raise a SendSMS event for scheduled delivery of an sms to mulitple recipients. An accompanying listener must be implemented which can deliver the message by interfacing with an sms provider.
