...
public class Activator implements BundleActivator {
    ...
    private static final String SERVLET_URL_MAPPING = "/mrs/api";
    private static final String RESOURCE_URL_MAPPING = "/mrs";

    private static final String MODULE_NAME = "mrs";
    ...
    public static class MrsApplicationContext extends MotechOsgiWebApplicationContext {

        public MrsApplicationContext() {
            super();
    ...
    private void serviceAdded(HttpService service) {
        try {
            ...
            dispatcherServlet.setContextClass(MrsApplicationContext.class);
    ...
    private void serviceAdded(UIFrameworkService service) {
        ...
        regData.setUrl("../mrs/");
        regData.addAngularModule("motech-mrs");

        regData.addI18N("messages", "../mrs/bundles/");
        ...
        logger.debug("MRS registered in UI framework");
    }

    private void serviceRemoved(UIFrameworkService service) {
        service.unregisterModule(MODULE_NAME);
        logger.debug("MRS unregistered from ui framework");
    }
}
