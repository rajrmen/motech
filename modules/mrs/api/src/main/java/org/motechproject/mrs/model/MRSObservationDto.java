...
public class MRSObservationDto implements MRSObservation<Object> {
    ...
    private Set<? extends MRSObservation> dependantObservations;

    public MRSObservationDto() {
    }

    public MRSObservationDto(String id, Date date, String conceptName, String patientId, Object value, Set<? extends MRSObservation> dependantObservations) {
        this.id = id;
        this.date = date;
    ...
    @Override
    public void setDependantObservations(Set<? extends MRSObservation> dependantObservations) {
        this.dependantObservations = dependantObservations;
    }
