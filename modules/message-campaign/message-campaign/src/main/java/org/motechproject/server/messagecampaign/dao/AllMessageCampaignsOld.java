...
@Component
public class AllMessageCampaignsOld {
    ...
    public AllMessageCampaignsOld(@Qualifier("messageCampaignSettings") SettingsFacade settings, MotechJsonReader motechJsonReader) {
        this.settings = settings;
        this.motechJsonReader = motechJsonReader;
    }

    @Autowired
    public AllMessageCampaignsOld(@Qualifier("messageCampaignSettings") SettingsFacade settings) {
