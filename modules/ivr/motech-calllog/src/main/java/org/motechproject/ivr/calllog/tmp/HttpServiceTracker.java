...
import org.motechproject.osgi.web.OsgiDispatcherServlet;
    ...
    private void register(HttpService httpService) {
        if (contextPath == null && httpService != null) {
            try {
                ...
                dispatcherServlet.setContextConfigLocation("META-INF/osgi/*.xml");
                ...
                try {
                    ...
                    httpService.registerServlet("/callLog/resources", new ResourceServlet(), null, null);
