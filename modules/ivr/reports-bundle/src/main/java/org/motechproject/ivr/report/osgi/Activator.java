package org.motechproject.ivr.report.osgi;
...
public class Activator implements BundleActivator {
    ...
    private static final String CONTEXT_CONFIG_LOCATION = "META-INF/osgi/applicationIVRReportsBundle.xml";
    private static final String SERVLET_URL_MAPPING = "/ivr_reports/api";
    private static final String RESOURCE_URL_MAPPING = "/ivr_reports";

    private static final String MODULE_NAME = "IVR Reports";
    ...
    private void serviceAdded(UIFrameworkService service) {
        ...
        regData.setUrl("../ivr_reports/");
        regData.addAngularModule("motech-ivr-reports");
...
//        regData.addI18N("messages", "../admin/bundles/");
        ...
        logger.debug("IVR Reports registered in UI framework");
    }

    private void serviceRemoved(UIFrameworkService service) {
        service.unregisterModule(MODULE_NAME);
        logger.debug("IVR Reports unregistered from UI framework");
    }
}
