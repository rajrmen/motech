...
public class DiagnosticResponseBuilder {
    ...
    public DiagnosticResponseBuilder() throws Exception {
        Properties velocityProperties = new Properties();
        velocityProperties.setProperty("file.resource.loader.path", "/tmp/motech/velocity");
    ...
    public String createResponseMessage(List<DiagnosticsResponse> diagnosticsResponses) {
        ...
        try {
            template = velocityEngine.getTemplate("diagnosticResponse.vm");
